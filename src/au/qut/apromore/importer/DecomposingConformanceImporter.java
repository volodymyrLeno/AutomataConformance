...
public class DecomposingConformanceImporter extends ImportProcessModel
{
	...
	public DecomposingConformanceImporter(Automaton modelFSM, UnifiedMap<IntArrayList, IntArrayList> caseTracesMapping, BiMap<Integer, IntArrayList> labelComponentsMapping, List<Automaton> sComponentFSMs,
										  FastList<Petrinet> sComponentNets, FastList<ImportProcessModel> sComponentImporters, Map<Integer, String> caseIDs, UnifiedMap<Integer, Automaton> componentDAFSAs,
										  UnifiedSet<IntArrayList> visited, IntObjectHashMap<UnifiedSet<IntArrayList>> componentsUniqueTraces, XLog xLog, UnifiedMap<IntArrayList, UnifiedMap<Integer, IntArrayList>> traceProjections,
										  UnifiedMap<Integer, UnifiedMap<IntArrayList, IntArrayList>> projectedLogs, String path, String model, boolean doDecomposition, BiMap<String, Integer> globalInverseLabels, BiMap<Integer, String> globalLabelMapping)
	{
