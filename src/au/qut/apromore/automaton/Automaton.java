...
public class Automaton {
	...
	public Automaton(Map<Integer, State> states, BiMap<Integer, String> labelMapping, BiMap<String, Integer> inverseLabelMapping, Map<Integer, Transition> transitions,
		...
		this.configDecoderMapping = configReducedTraceMapping;
		TransitionComparator tComp = new TransitionComparator();
		for(State st : this.states.values())
		{
			st.incomingTransitions().sortThis(tComp);
	...
	public IntHashSet getParallelLabels(){ return this.parallelLabels;}

	public void setParallelLabels(IntHashSet parallelLabels) {this.parallelLabels = parallelLabels;}
...
//		pw.close();
	...
	public void setMinNumberOfModelMoves(int cost)
	{
		this.minNumberOfModelMoves = cost;
	}
	...
	public UnifiedMap<IntIntHashMap,UnifiedSet<IntArrayList>> getConfigDecoderMapping()
	{
		return this.configDecoderMapping;
	}
}
