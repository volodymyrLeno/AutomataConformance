...
public class State {
	...
	private FastList<Transition> outgoingTransitions = new FastList<>();
	private FastList<Transition> incomingTransitions = new FastList<>();
	...
	private Set<IntArrayList> possiblePaths;
...
//		if (!(id>=0)) {return;}
	...
	public FastList<Transition> outgoingTransitions()
	{
		if (this.outgoingTransitions == null){this.outgoingTransitions = new FastList<Transition>();}
		return this.outgoingTransitions;
	}
	
	public FastList<Transition> incomingTransitions()
	{
		if (this.incomingTransitions == null){this.incomingTransitions = new FastList<Transition>();}
...
//	}
	...
	public Set<IntArrayList> possibleFuturePaths()
	{
		if(this.possiblePaths==null)
		{
			this.possiblePaths = new UnifiedSet<IntArrayList>();
		}
